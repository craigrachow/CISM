...
> **Exam mindset:** Governance is about **direction, oversight, and accountability**, not technical implementation.
...
**Key points:**
- “Tone at the top” drives behaviour.
...
**Example:**  
A cloud contract requires breach notification within a defined timeframe.
...
**ISACA context:**  
Clear roles and responsibilities ensure effective governance, decision-making, and segregation of duties.

**Key points:**
- Board sets risk appetite and oversight. Highest governing body. 
- Senior management is accountable.
- CISO advises and reports.
...
**Example:**  
A system owner decides whether to accept residual risk after mitigation.
...
**ISACA context:**  
Information security strategy defines how security supports and enables business objectives.
...
**ISACA context:**  
Frameworks and standards provide structured approaches to governing information security.

**Key points:**
- COBIT, ISO 27001, NIST are commonly used.
- Support consistency and maturity.
- Enable benchmarking and assurance.
- Frameworks guide governance, not configuration.

**Memory hook:**  
> *Frameworks provide structure, not tools.*
...
**ISACA context:**  
Strategic planning ensures security initiatives are resourced and prioritised appropriately.

**Key points:**
- Budgets align with risk and value.
